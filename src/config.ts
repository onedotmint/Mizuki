...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://dotmint.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/onedotmint",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/413283792",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/dotmint",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/isekai.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "一点薄荷",
